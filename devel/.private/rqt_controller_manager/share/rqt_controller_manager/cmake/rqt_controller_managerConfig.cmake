...
if("TRUE" STREQUAL "TRUE")
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /home/shimin/ROS_Prgm_Prj/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shimin/ROS_Prgm_Prj/src/debug_tool/ros_control/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shimin/ROS_Prgm_Prj/devel/.private/rqt_controller_manager/lib;/home/shimin/ROS_Prgm_Prj/devel/lib;/home/shimin/en530_707_catkin_ws/devel/lib;/opt/ros/kinetic/lib)
