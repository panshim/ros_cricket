...
"""autogenerated by genpy from lwr_controllers/Stiffness.msg. Do not edit."""
import sys
...
class Stiffness(genpy.Message):
  _md5sum = "88d995302418aa13534aa14fc9aeed94"
  _type = "lwr_controllers/Stiffness"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# This represents a diagonal Cartesian stiffness
...
float64 rz"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Stiffness, self).__init__(*args, **kwds)
