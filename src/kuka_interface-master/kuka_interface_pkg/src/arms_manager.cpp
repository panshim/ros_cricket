...
ArmsManager::ArmsManager()
{
    ...
    traj_right.joint_names.push_back("lwr_a1_joint");
    traj_right.joint_names.push_back("lwr_a2_joint");
    traj_right.joint_names.push_back("lwr_e1_joint");
    traj_right.joint_names.push_back("lwr_a3_joint");
    traj_right.joint_names.push_back("lwr_a4_joint");
    traj_right.joint_names.push_back("lwr_a5_joint");
    traj_right.joint_names.push_back("lwr_a6_joint");
    ...
    sub_right = nh.subscribe("/kuka_command",1,&ArmsManager::callback_right,this);
    ...
    pub_command_right = nh.advertise<trajectory_msgs::JointTrajectory>("/lwr/joint_trajectory_controller/command", 10);
